...
declare namespace R {
    ...
    interface ListIterator<T, TResult> {
        (value: T, index: number, list: ReadonlyArray<T>): TResult;
    }
    ...
    interface Static {
        ...
        */
       addIndex<T,U>(fn: (f: (item: T) => U, list: ReadonlyArray<T>) => ReadonlyArray<U> )
         : CurriedFunction2<(item: T, idx: number, list?: ReadonlyArray<T>) => U, ReadonlyArray<T>, ReadonlyArray<U>>;
       /* Special case for forEach */
       addIndex<T>(fn: (f: (item: T) => void, list: ReadonlyArray<T>) => ReadonlyArray<T>)
         : CurriedFunction2<(item: T, idx: number, list?: ReadonlyArray<T>) => void, ReadonlyArray<T>, ReadonlyArray<T>>;
       /* Special case for reduce */
       addIndex<T,U>(fn: (f: (acc:U, item: T) => U, aci:U, list: ReadonlyArray<T>) => U)
         : CurriedFunction3<(acc:U, item: T, idx: number, list?: ReadonlyArray<T>) => U, U, ReadonlyArray<T>, U>;
        ...
        */
         ...
         */
        aperture<T>(n: number, list: ReadonlyArray<T>): ReadonlyArray<ReadonlyArray<T>>;
        aperture(n: number): <T>(list: ReadonlyArray<T>) => ReadonlyArray<ReadonlyArray<T>>;
         ...
         */
        binary(fn: (...args: ReadonlyArray<any>) => any): Function;
        ...
        */
         ...
         */
        cond(fns: ReadonlyArray<[Pred, Function]>): Function;
         ...
         */
        converge(after: Function, fns: ReadonlyArray<Function>): Function;
         ...
         */
        curryN(length: number, fn: (...args: ReadonlyArray<any>) => any): Function;
         ...
         * element matches.
         */
        find<T>(fn: (a: T) => boolean, list: ReadonlyArray<T>): T;
        find<T>(fn: (a: T) => boolean): (list: ReadonlyArray<T>) => T;
         ...
         * element matches.
         */
        findLast<T>(fn: (a: T) => boolean, list: ReadonlyArray<T>): T;
        findLast<T>(fn: (a: T) => boolean): (list: ReadonlyArray<T>) => T;
         ...
         */
        flatten<T>(x: ReadonlyArray<ReadonlyArray<T>>): ReadonlyArray<T>;
        flatten<T>(x: ReadonlyArray<T>): ReadonlyArray<T>;
         ...
         */
        groupWith<T>(fn: (x: T, y: T) => boolean, list: ReadonlyArray<T>): ReadonlyArray<ReadonlyArray<T>>
         ...
         */
        into<T>(acc: any, xf: Function, list: ReadonlyArray<T>): ReadonlyArray<T>;
        into(acc: any, xf: Function): <T>(list: ReadonlyArray<T>) => ReadonlyArray<T>;
        into(acc: any): <T>(xf: Function, list: ReadonlyArray<T>) => ReadonlyArray<T>;
        ...
        */
         ...
         */
        lift(fn: Function, ...args: ReadonlyArray<any>): any;
         ...
         */
        liftN(n: number, fn: Function, ...args: ReadonlyArray<any>): any;
         ...
         */
        nAry(n: number, fn: (...arg: ReadonlyArray<any>) => any): Function;
        ...
        //of<T>(x: ReadonlyArray<T>): ReadonlyArray<T>[]; unnecessary typing and introduced error in unless example
         ...
         */
        partial(fn: Function, ...args: ReadonlyArray<any>): Function;
         ...
         */
        partialRight(fn: Function, ...args: ReadonlyArray<any>): Function;

        /**
         * Takes a predicate and a list and returns the pair of lists of elements
         * which do and do not satisfy the predicate, respectively.
         */
        partition(fn: (a: string) => boolean, list: ReadonlyArray<string>): ReadonlyArray<ReadonlyArray<string>>;
        partition<T>(fn: (a: T) => boolean, list: ReadonlyArray<T>): ReadonlyArray<ReadonlyArray<T>>;
        partition<T>(fn: (a: T) => boolean): (list: ReadonlyArray<T>) => ReadonlyArray<ReadonlyArray<T>>;
        partition(fn: (a: string) => boolean): (list: ReadonlyArray<string>) => ReadonlyArray<ReadonlyArray<string>>;
        ...
        */
         ...
         * property is ignored.
         */
        pick<T,U>(names: ReadonlyArray<string>, obj: T): U;
         ...
         */
        sortBy<T>(fn: (a: any) => string, list: ReadonlyArray<T>): ReadonlyArray<T>;
        sortBy(fn: (a: any) => string): <T>(list: ReadonlyArray<T>) => ReadonlyArray<T>;

        /**
         * Splits a string into an array of strings based on the given
         * separator.
         */
        split(sep: string): (str: string) => ReadonlyArray<string>;
        split(sep: RegExp): (str: string) => ReadonlyArray<string>;
        split(sep: string, str: string): ReadonlyArray<string>;
        split(sep: RegExp, str: string): ReadonlyArray<string>;
        ...
        splitAt<T>(index: number, list: ReadonlyArray<T>): ReadonlyArray<ReadonlyArray<T>>;
        splitAt(index: number): <T>(list: ReadonlyArray<T>) => ReadonlyArray<ReadonlyArray<T>>;

        /**
         * Splits a collection into slices of the specified length.
         */
        splitEvery<T>(a: number, list: ReadonlyArray<T>): ReadonlyArray<ReadonlyArray<T>>;
        splitEvery(a: number): <T>(list: ReadonlyArray<T>) => ReadonlyArray<ReadonlyArray<T>>;
         ...
         */
        splitWhen<T,U>(pred: (val: T) => boolean, list: ReadonlyArray<U>): ReadonlyArray<ReadonlyArray<U>>;
        splitWhen<T>(pred: (val: T) => boolean): <U>(list: ReadonlyArray<U>) => ReadonlyArray<ReadonlyArray<U>>;
        ...
        symmetricDifferenceWith<T>(pred: (a: T, b: T) => boolean): CurriedFunction2<ReadonlyArray<T>, ReadonlyArray<T>, ReadonlyArray<T>>;
         ...
         */
        transpose<T>(list: ReadonlyArray<ReadonlyArray<any>>): ReadonlyArray<ReadonlyArray<any>>;
         ...
         */
        tryCatch<T>(tryer: (...args: ReadonlyArray<any>) => T, catcher: (...args: ReadonlyArray<any>) => T, x: any): T;
         ...
         */
        unfold<T, TResult>(fn: (seed: T) => ReadonlyArray<TResult>|boolean, seed: T): ReadonlyArray<TResult>;
        unfold<T, TResult>(fn: (seed: T) => ReadonlyArray<TResult>|boolean): (seed: T) => ReadonlyArray<TResult>;
        ...
        unionWith<T>(pred: (a: T, b: T) => boolean): CurriedFunction2<ReadonlyArray<T>, ReadonlyArray<T>, ReadonlyArray<T>>
         ...
         * them in a new array.
         */
        unnest<T>(x: ReadonlyArray<ReadonlyArray<T>>): ReadonlyArray<T>;
        unnest<T>(x: ReadonlyArray<T>): ReadonlyArray<T>;
         ...
         */
        useWith(fn: Function, transformers: ReadonlyArray<Function>): Function;
         ...
         */
        values<T>(obj: {[index: string]: T}): ReadonlyArray<T>;
        values<T>(obj: any): ReadonlyArray<T>;
