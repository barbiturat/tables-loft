...
const tTableType = t.enums.of(
  ['pool', 'shuffleBoard', 'tableTennis', 'generic'],
  'tTableType'
);
...
const tPositiveNullableInt = t.intersection(
  [tPositive, tNullableInt],
  'tPositiveNullableInt'
);
const tNonEmptyString = t.refinement(
  t.String,
  (str: string) => !!str,
  'tNonEmptyString'
);
