...
// Source: node_modules/redux-observable/index.d.ts
...
export function createEpicMiddleware<T>(rootEpic: Epic<T>): EpicMiddleware<T>;

export function combineEpics<T>(...epics: Epic<T>[]): Epic<T>;
}
